...
export default function StatsDashboardV2() {
  ...
  return (
    <div
      className="mx-auto -mt-2 flex h-[calc(100dvh-3.5rem)] w-full min-w-0 max-w-6xl flex-col overflow-hidden rounded-xl border border-slate-700 bg-slate-900 shadow-xl md:-mt-3"
    >
