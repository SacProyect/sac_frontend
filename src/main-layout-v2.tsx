...
const MainLayoutV2 = () => {
    ...
    const getNavItems = () => {
        ...
        const baseRoutes = [
            ...
            { href: '/census', label: 'Tabla Censo', icon: '📋' },
            { href: '/fiscal-review', label: 'Revisión Fiscal', icon: '✅' },
            { href: '/gen-reports', label: 'Reportes', icon: '📊' },
        ...
        if (user.role === 'ADMIN' || user.role === 'COORDINATOR') {
            baseRoutes.push(
                { href: '/iva', label: 'Reporte IVA', icon: '📄' },
                { href: '/islr', label: 'Reporte ISLR', icon: '📄' },
                { href: '/index-iva', label: 'Índice IVA', icon: '📑' },
                { href: '/contributions', label: 'Contribuciones', icon: '💰' }
            );
        } else if (user.role === 'SUPERVISOR') {
            baseRoutes.push(
                { href: `/stats/fiscal/${user.id}`, label: 'Estadísticas', icon: '📈' },
                { href: '/iva', label: 'Reporte IVA', icon: '📄' },
                { href: '/islr', label: 'Reporte ISLR', icon: '📄' },
                { href: '/contributions', label: 'Contribuciones', icon: '💰' }
            );
