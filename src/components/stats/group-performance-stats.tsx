...
export const GroupPerformanceStats = ({ groupStats }: Props) => {
    ...
    return (
        <div className="w-full h-full pt-16 lg:w-full lg:h-full lg:pt-0">
            <div className="bg-slate-900 p-4 w-full h-full lg:h-full flex flex-col">
                <div className="mb-2 text-xl font-semibold text-center text-white font-inter">
                    <div className="flex justify-center">
                        <p className="w-full lg:w-96 bg-slate-800 border border-slate-600 py-1 rounded-md text-[14px] lg:text-sm">
                            RENDIMIENTO POR GRUPO
                        </p>
                    </div>
                </div>

                <p className="text-[11px] md:text-xs text-slate-500 mb-2 font-inter text-center leading-5 px-2">
                ...
                <div className="pt-4 pr-1 overflow-y-auto lg:flex lg:flex-col lg:w-full lg:h-full lg:px-8 custom-scroll">
                    {sortedStats.map((group, i) => (
                        <div key={i} className="mb-6">
                            <div className="text-slate-300 text-sm mb-1 text-center lg:text-left">
                                {group.groupName}
                            </div>

                            {/* Multas pagadas */}
                            <div className="flex flex-col w-full mb-1 lg:flex-row lg:items-center lg:space-x-3">
                                <div className="text-blue-400 text-xs w-full lg:w-full text-center lg:text-left">
                                    Multas Asignadas
                                </div>
                                <div className="relative h-[18px] bg-slate-700 lg:max-w-full w-full rounded-full mt-1 lg:mt-0">
                                    <div
                                        className="absolute top-0 left-0 h-full bg-blue-500 rounded-full"
                                        style={{ width: getBarWidth(group.totalPaidFines, totalPaid) }}
                                    />
                                </div>
                                <div className="text-blue-400 text-xs min-w-[40px] text-left mt-1 lg:mt-0">
                            ...
                            <div className="flex flex-col w-full mb-1 lg:flex-row lg:items-center lg:space-x-3">
                                <div className="text-emerald-400 text-xs w-full lg:w-full text-center lg:text-left">
                                    Pagado Multas
                                </div>
                                <div className="relative h-[18px] bg-slate-700 lg:max-w-full w-full rounded-full mt-1 lg:mt-0">
                                    <div
                                ...
                                <div className="text-emerald-400 text-xs min-w-[40px] text-left mt-1 lg:mt-0">
                            ...
                            {/* IVA */}
                            <div className="flex flex-col w-full mb-1 lg:flex-row lg:items-center lg:space-x-3">
                                <div className="text-amber-400 text-xs w-full text-center lg:text-left">
                                    IVA Pagado
                                </div>
                                <div className="relative h-[18px] bg-slate-700 lg:max-w-full w-full rounded-full mt-1 lg:mt-0">
                                    <div
                                ...
                                <div className="text-amber-400 text-xs min-w-[40px] text-left mt-1 lg:mt-0">
                            ...
                            <div className="flex flex-col w-full lg:flex-row lg:items-center lg:space-x-3">
                                <div className="text-red-400 text-xs w-full lg:w-full text-center lg:text-left">
                                    ISLR Pagado
                                </div>
                                <div className="relative h-[18px] bg-slate-700 lg:max-w-full w-full rounded-full mt-1 lg:mt-0">
                                    <div
                                ...
                                <div className="text-red-400 text-xs min-w-[40px] text-left mt-1 lg:mt-0">
