            ...
            <div className="bg-[#2a2a29] border-[#3a3a39] text-white rounded-xl lg:h-[35vh]">
                <div className="flex flex-row items-center justify-between pb-3">
                    <div className="flex items-center gap-2 pt-4 pl-4 text-base font-semibold">
                        ...
                        Contribuyentes con Alto Cumplimiento (&gt;67%) ({compliance?.length ?? 0})
                    </div>
                    <div className="flex pt-4 pr-4 space-x-2">
                        ...
                        <button
                            onClick={() =>
                                compliance &&
                                exportExcel(compliance, "alto-cumplimiento-fiscal", fiscalData.fiscalName)
                            }
                ...
                <div className="pt-0">
                    <div id="alto-cumplimiento-fiscal-table" className="h-[280px] lg:h-[25vh] overflow-y-auto custom-scroll p-4">
