...
function DateInputUI({ control, name, label }) {
    return (
        <Controller
            control={control}
            name={name}
            ...
            render={({
                ...
                >
                    ...
                    <Popover >
                        <Dialog>
                            <Calendar className={"bg-white w-60 rounded-2xl shadow-2xl border border-black h-56"}>
                                <header className='flex w-full justify-between px-4 pt-2'>
                                    <InputButton
                                        slot="previous">
                                        ◀
                                    </InputButton>
