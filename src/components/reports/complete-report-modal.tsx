...
import { getCompleteReport } from "../utils/api/report-functions";
...
const CompleteReportModal: React.FC<Props> = ({ onClose, groups }) => {
    ...
    if (user.role === "SUPERVISOR") {
        ...
        const groupId = user.coordinatedGroup && typeof user.coordinatedGroup === "object" && "id" in user.coordinatedGroup ? user.coordinatedGroup.id : undefined;
        if (!groupId) toast.error("No se pudo encontrar el id correspondiente a su grupo.");
